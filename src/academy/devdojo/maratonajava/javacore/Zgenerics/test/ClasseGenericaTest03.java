...
public class ClasseGenericaTest03 {
    public static void main(String[] args) {
        ...
        List<Carro> carrosDisponiveis =
                new ArrayList<>(List.of(new Carro("BMW"), new Carro("Fusca")));
        List<Barco> barcosDisponiveis =
                new ArrayList<>(List.of(new Barco("Lancha"), new Barco("Iate")));

        RentalService<Carro> rentalServiceCarro =
                new RentalService<>(carrosDisponiveis);
        ...
        RentalService<Barco> rentalServiceBarco =
                new RentalService<>(barcosDisponiveis);
